...
HD_PWD='C:/Xilinx/Projects/respmealyM5/respmealyM5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log doorlock_mealy.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source doorlock_mealy.tcl -notrace
