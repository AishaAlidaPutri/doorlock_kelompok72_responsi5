...
HD_PWD='C:/Xilinx/Projects/respmealyM5/respmealyM5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log doorlock_mealy.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source doorlock_mealy.tcl
